...
def get_match_kickoff(
    ...
    if not match:
        ...
        raise ValueError(
            "Anstoßzeit konnte nicht gefunden werden."
        )
...
def get_bundesliga2_upcoming_matches(
    days_ahead: int = 2,
):
    ...
    if not links:
        ...
        raise ValueError(
            "Keine 2.-Bundesliga-Match-Links gefunden."
        )
